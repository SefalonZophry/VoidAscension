...
public class AltarStructure extends Structure<NoFeatureConfig> {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return AltarStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registry(Registry.TEMPLATE_POOL_REGISTRY)
                            .get().get(new ResourceLocation(VoidAscension.MOD_ID, "altar/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Altar at " +
