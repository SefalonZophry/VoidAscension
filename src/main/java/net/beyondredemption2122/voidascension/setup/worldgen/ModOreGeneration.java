...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInSpecificModBiome(VoidTouchedBome.VOID_TOUCHED_BIOME.get(), OreType.RIFT_CRYSTAL_ORE, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificModBiome(DeepVoid.DEEP_VOID.get(), OreType.RIFT_CRYSTAL_ORE, event, ModDimensions.Void.toString());
    ...
    private static OreFeatureConfig getVoidFeatureConfig(OreType ore) {
        return new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
                ore.getBlock().get().defaultBlockState(), ore.getMaxVeinSize());
    }
    ...
    private static ConfiguredFeature<?, ?> makeOreFeature(OreType ore, String dimensionToSpawnIn) {
        ...
        } else if(dimensionToSpawnIn.equals(ModDimensions.Void.toString())) {
            oreFeatureConfig = getVoidFeatureConfig(ore);
        }
