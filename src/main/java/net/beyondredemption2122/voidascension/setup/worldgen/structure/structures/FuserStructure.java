package net.beyondredemption2122.voidascension.setup.worldgen.structure.structures;
...
public class FuserStructure extends Structure<NoFeatureConfig>{

    public FuserStructure() {
    ...
    public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
        return FuserStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registry(Registry.TEMPLATE_POOL_REGISTRY)
                            .get().get(new ResourceLocation(VoidAscension.MOD_ID, "fuser/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Fuser at " +
