...
public class KeepStructure extends Structure<NoFeatureConfig> {
    public KeepStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return KeepStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registry(Registry.TEMPLATE_POOL_REGISTRY)
                            .get().get(new ResourceLocation(VoidAscension.MOD_ID, "keep/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Keep at " +
