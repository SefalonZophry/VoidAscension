...
public class Biomes {
    public static final ResourceKey<Biome> VOID_TOUCHED_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(VoidAscension.MOD_ID, "void_touched_forest"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(VOID_TOUCHED_FOREST, voidtouchedforest(context));
        context.register(DeepVoid.DEEP_VOID, DeepVoid.deepvoid(context));
    }
    ...
    public static Biome voidtouchedforest(BootstapContext<Biome> context) {
