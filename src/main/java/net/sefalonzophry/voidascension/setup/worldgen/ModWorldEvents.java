...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.ALTAR.get(),
                    DimensionStructuresSettings.DEFAULTS.get(ModStructures.ALTAR.get()));
            serverWorld.getChunkSource().generator.getSettings().structureConfig = tempMap;

            tempMap.putIfAbsent(ModStructures.FUSER.get(),
                    DimensionStructuresSettings.DEFAULTS.get(ModStructures.FUSER.get()));
            serverWorld.getChunkSource().generator.getSettings().structureConfig =tempMap;
