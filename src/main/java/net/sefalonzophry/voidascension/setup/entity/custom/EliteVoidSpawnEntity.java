...
public class EliteVoidSpawnEntity extends Monster {
    public EliteVoidSpawnEntity(EntityType<? extends Monster> p_i48553_1_, Level p_i48553_2_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new RandomStrollGoal(this, 0.30F));
